...
- **DocumentManager UI (`components/data-room/DocumentManager.tsx`):**
  ...
  - **Upload into folder** select in the upload panel — defaults to the folder you’re viewing, can be overridden to Room root or any folder; uploads send **`parentFolderId`** on prepare/finalize. Default upload type select sits beside it.
